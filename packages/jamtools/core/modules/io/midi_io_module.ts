...
// createIoDependencies = async () => {
//     const qwerty = new MockQwertyService();
//     const {BrowserMidiService} = await import('@jamtools/core/services/browser/browser_midi_service');

//     const {requestMIDIAccess} = await import('@motiz88/react-native-midi');
//     // "@motiz88/react-native-midi": "github:jamtools/react-native-midi#8e5b0798dc7333cd434421b514e521671b496c4e"

//     const midi = new BrowserMidiService({
//         requestMIDIAccessFunction: requestMIDIAccess,
//     });
//     return {
//         qwerty,
//         midi,
...
export default (sb: typeof springboard) => sb.registerClassModule((coreDeps: CoreDependencies, modDependencies: ModuleDependencies) => {
