...
export class PartyKitRpcClient {
    constructor(host, room, queryParams) {
        ...
        this.initializeWebsocket = async () => {
        ...
        this.reconnect = async (queryParams) => {
            this.conn.close();
        ...
        this.sendHttpRpcRequest = async (req) => {
